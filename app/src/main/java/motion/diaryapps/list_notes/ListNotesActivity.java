...
public class ListNotesActivity extends AppCompatActivity {
    ...
    public void initDummy() {
        ...
        mLists.add(new ListNotesModel("1","https://i.ibb.co/y8XHwYS/island.png", Tools.getCurrentDateISO8601() ,"Lost Paradise"));
        mLists.add(new ListNotesModel("1","https://i.ibb.co/y8XHwYS/island.png", Tools.getCurrentDateISO8601() ,"Lost Paradise2"));
        mLists.add(new ListNotesModel("1","https://i.ibb.co/y8XHwYS/island.png", Tools.getCurrentDateISO8601() ,"Lost Paradise3"));
        mLists.add(new ListNotesModel("1","https://i.ibb.co/y8XHwYS/island.png", Tools.getCurrentDateISO8601() ,"Lost Paradise4"));
        mLists.add(new ListNotesModel("1","https://i.ibb.co/y8XHwYS/island.png", Tools.getCurrentDateISO8601() ,"Lost Paradise5"));
